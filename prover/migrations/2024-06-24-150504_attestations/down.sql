...
DROP INDEX IF EXISTS block_with_digests_idx_chain_id;
DROP INDEX IF EXISTS block_with_digests_idx_header_number;
DROP INDEX IF EXISTS block_with_digests_idx_digest;
...
DROP TABLE IF EXISTS BlockWithDigests;
