...
The chain key is generated by pallet SupportedChain and is incremental from 0:

## Based on genesis:
- Chain key 0 for chain id 1 name 'Ethereum'
- Chain key 1 for chain id 31337 name 'Local anvil'
- Chain key 2 for chain id 11155111 name 'Sepolia ethereum'
