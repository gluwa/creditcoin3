...
// Local
use creditcoin_next_runtime::{opaque::Block, AccountId, Balance, Nonce};
...
pub type Client = FullClient<creditcoin_next_runtime::RuntimeApi, TemplateRuntimeExecutor>;
...
impl NativeExecutionDispatch for TemplateRuntimeExecutor {
    ...
    fn dispatch(method: &str, data: &[u8]) -> Option<Vec<u8>> {
        creditcoin_next_runtime::api::dispatch(method, data)
    }

    fn native_version() -> NativeVersion {
        creditcoin_next_runtime::native_version()
    }
}
