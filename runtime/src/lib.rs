...
parameter_types! {
    ...
    pub PrecompilesValue: GluwaPrecompiles<Runtime> = GluwaPrecompiles::<_>::new();
...
construct_runtime!(
    pub enum Runtime {
        ...
        ImOnline: pallet_im_online = 9,

        VoterList: pallet_bags_list::<Instance1> = 10,
        Historical: session_historical = 11,
        TransactionPayment: pallet_transaction_payment = 12,
        Sudo: pallet_sudo = 13,
        Utility: pallet_utility = 14,
        Proxy: pallet_proxy = 15,
        Identity: pallet_identity = 16,
        FastUnstake: pallet_fast_unstake = 17,
        NominationPools: pallet_nomination_pools = 18,

        Ethereum: pallet_ethereum = 19,
        EVM: pallet_evm = 20,
        EVMChainId: pallet_evm_chain_id = 21,
        DynamicFee: pallet_dynamic_fee = 22,
        BaseFee: pallet_base_fee = 23,
        HotfixSufficients: pallet_hotfix_sufficients = 24,

        Attestation: pallet_attestation_poc = 25,
        SupportedChains: pallet_supported_chains = 26,
        Prover: pallet_prover = 27,

        Randomness: pallet_randomness = 28,
    }
);
