...
pub trait Creditcoin3Ext {
    ...
    /// An `Evm` event proxied by the Creditcoin3 runtime to this host function.
    /// evm -> creditcoin3_runtime -> host.
    ...
    /// A `Gasometer` event proxied by the Creditcoin3 runtime to this host function.
    /// evm_gasometer -> creditcoin3_runtime -> host.
    ...
    /// A `Runtime` event proxied by the Creditcoin3 runtime to this host function.
    /// evm_runtime -> creditcoin3_runtime -> host.
