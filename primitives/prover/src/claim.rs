...
#[test]
fn test_claim_query() {
    use crate::claim_query::LegacyClaimQueryField::*;
    ...
    let claim_query = crate::claim_query::TxClaimQuery::try_from(
        vec![SingleDataRelativeRange(Some(0..418))]
            .into_iter()
            .collect::<HashSet<_>>(),
    )
    .unwrap();
