...
pub const PRECOMPILE_ADDRESS: u64 = 4052; // 0x0FD4
...
impl AddressMapping<Account> for Account {
    fn into_account_id(h160_account: H160) -> Account {
        match h160_account {
            ...
            a if a == H160::repeat_byte(0xA1) => Self::AttestorA,
            a if a == H160::repeat_byte(0xA2) => Self::AttestorB,
...
impl From<Account> for H160 {
    fn from(x: Account) -> H160 {
        match x {
            ...
            Account::AttestorA => H160::repeat_byte(0xA1),
            Account::AttestorB => H160::repeat_byte(0xA2),
...
pub type Precompiles<R> = PrecompileSetBuilder<
    R,
    (PrecompileAt<AddressU64<PRECOMPILE_ADDRESS>, AttestorStashPrecompile<R>>,),
>;

pub type PCall = AttestorStashPrecompileCall<Runtime>;
...
pub const TEST_CHAIN_KEY: u64 = 1;
