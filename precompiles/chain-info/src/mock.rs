...
pub const SUPPORTED_CHAIN_ID: u64 = 1;
pub const SUPPORTED_CHAIN_NAME: &[u8] = b"Ethereum";
pub const SUPPORTED_CHAIN_ENCODING: ChainEncodingVersion = ChainEncodingVersion::V1;
...
pub type Precompiles<R> =
    PrecompileSetBuilder<R, (PrecompileAt<AddressU64<1>, ChainInfoPrecompile<R>>,)>;

pub type PCall = ChainInfoPrecompileCall<Runtime>;
