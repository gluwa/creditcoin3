...
const contractABI = contractABIJSON.contracts['sol/ed25519_verifier.sol:Ed25519Verifier'].abi;
...
describe('Precompile: Ed25519Verifier.verify()', (): void => {
    ...
    beforeAll(async () => {
        ...
        // Precompile contract deployed at 5050 (0x13BA) in hex, see runtime/src/precompiles.rs
        const precompileContractAddress = '0x00000000000000000000000000000000000013bA';
