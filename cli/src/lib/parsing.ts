...
export function parseHexStringInternal(input: string): string {
    if (!RegExp(/^0x[\da-f]+$/i).exec(input)) {
...
export function inputOrDefault(input: string | undefined, defaultValue: string): string {
    if (input === undefined) {
        return defaultValue;
    }
    return input;
...
export function requiredInput(input: string | undefined, message: string): string {
    if (input === undefined) {
