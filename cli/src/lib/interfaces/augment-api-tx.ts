...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    proxy: {
       ...
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: FrontierTemplateRuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, FrontierTemplateRuntimeProxyFilter, u32]>;
      /**
       * See [`Pallet::announce`].
       **/
       ...
       **/
      createPure: AugmentedSubmittable<(proxyType: FrontierTemplateRuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array, index: u16 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrontierTemplateRuntimeProxyFilter, u32, u16]>;
      /**
       * See [`Pallet::kill_pure`].
       **/
      killPure: AugmentedSubmittable<(spawner: AccountId20 | string | Uint8Array, proxyType: FrontierTemplateRuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, FrontierTemplateRuntimeProxyFilter, u16, Compact<u32>, Compact<u32>]>;
      /**
       * See [`Pallet::proxy`].
       **/
      proxy: AugmentedSubmittable<(real: AccountId20 | string | Uint8Array, forceProxyType: Option<FrontierTemplateRuntimeProxyFilter> | null | Uint8Array | FrontierTemplateRuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, Option<FrontierTemplateRuntimeProxyFilter>, Call]>;
      /**
       * See [`Pallet::proxy_announced`].
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, real: AccountId20 | string | Uint8Array, forceProxyType: Option<FrontierTemplateRuntimeProxyFilter> | null | Uint8Array | FrontierTemplateRuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, AccountId20, Option<FrontierTemplateRuntimeProxyFilter>, Call]>;
      /**
       ...
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId20 | string | Uint8Array, proxyType: FrontierTemplateRuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId20, FrontierTemplateRuntimeProxyFilter, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    session: {
       ...
       * See [`Pallet::set_keys`].
       **/
      setKeys: AugmentedSubmittable<(keys: FrontierTemplateRuntimeOpaqueSessionKeys | { grandpa?: any; babe?: any; imOnline?: any } | string | Uint8Array, proof: Bytes | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrontierTemplateRuntimeOpaqueSessionKeys, Bytes]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    utility: {
       ...
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: FrontierTemplateRuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [FrontierTemplateRuntimeOriginCaller, Call]>;
      /**
