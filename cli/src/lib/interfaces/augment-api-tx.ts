...
import type { AttestorPrimitivesSignedAttestation, Creditcoin3RuntimeOpaqueSessionKeys, Creditcoin3RuntimeOriginCaller, Creditcoin3RuntimeProxyFilter, EthereumTransactionTransactionV2, PalletAttestationPocRewardDestination, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletIdentityJudgement, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletNominationPoolsBondExtra, PalletNominationPoolsClaimPermission, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsConfigOpAccountId32, PalletNominationPoolsConfigOpPerbill, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsPoolState, PalletProverPrimitivesQuery, PalletStakingPalletConfigOpPerbill, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingRewardDestination, PalletStakingValidatorPrefs, SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusGrandpaEquivocationProof, SpConsensusSlotsEquivocationProof, SpSessionMembershipProof, SpWeightsWeightV2Weight } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    attestation: {
       ...
       **/
      bootstrapChain: AugmentedSubmittable<(attestation: AttestorPrimitivesSignedAttestation | { attestation?: any; signature?: any; attestors?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AttestorPrimitivesSignedAttestation]>;
      /**
       * See [`Pallet::chill`].
       **/
      chill: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64]>;
      /**
       ...
       **/
      commitAttestation: AugmentedSubmittable<(attestation: AttestorPrimitivesSignedAttestation | { attestation?: any; signature?: any; attestors?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AttestorPrimitivesSignedAttestation]>;
      /**
       ...
       **/
      setChainReward: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, reward: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128]>;
      /**
       * See [`Pallet::set_committee_set_size`].
       **/
      setCommitteeSetSize: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, newCommitteeSetSize: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u32]>;
      /**
       ...
       **/
      setMinBondRequirement: AugmentedSubmittable<(minBondRequirement: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u128]>;
      /**
       * See [`Pallet::set_payee`].
       **/
      setPayee: AugmentedSubmittable<(payee: PalletAttestationPocRewardDestination | { Stash: any } | { Account: any } | { None: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [PalletAttestationPocRewardDestination]>;
      /**
    ...
    prover: {
       ...
       **/
      removeStarkProgramMetadata: AugmentedSubmittable<(programVersion: u8 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u8]>;
      /**
       * See [`Pallet::set_stark_program_metadata`].
       **/
      setStarkProgramMetadata: AugmentedSubmittable<(programVersion: u8 | AnyNumber | Uint8Array, programAuthHash: H256 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u8, H256]>;
      /**
       * See [`Pallet::submit_proof`].
       **/
      submitProof: AugmentedSubmittable<(proof: Bytes | string | Uint8Array, query: PalletProverPrimitivesQuery | { chainId?: any; height?: any; index?: any; layoutSegments?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Bytes, PalletProverPrimitivesQuery]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    supportedChains: {
       ...
       **/
      registerChain: AugmentedSubmittable<(chainId: u64 | AnyNumber | Uint8Array, chainName: Text | string) => SubmittableExtrinsic<ApiType>, [u64, Text]>;
      /**
    ...
    utility: {
       ...
       **/
      dispatchAs: AugmentedSubmittable<(asOrigin: Creditcoin3RuntimeOriginCaller | { system: any } | { Void: any } | { Ethereum: any } | string | Uint8Array, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Creditcoin3RuntimeOriginCaller, Call]>;
      /**
