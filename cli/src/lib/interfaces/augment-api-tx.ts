...
import type { Bytes, Compact, Option, Text, U256, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    attestation: {
      attest: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, blsPublicKey: U8aFixed | string | Uint8Array, proofOfPossession: U8aFixed | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, U8aFixed, U8aFixed]>;
      authorizeAttestor: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestorId: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32]>;
      chill: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestorId: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32]>;
      /**
       ...
       **/
      commitAttestation: AugmentedSubmittable<(attestation: AttestorPrimitivesSignedAttestation | { attestation?: any; signature?: any; attestors?: any; continuityProof?: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AttestorPrimitivesSignedAttestation]>;
      /**
       ...
       **/
      forceElection: AugmentedSubmittable<(epoch: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64]>;
      /**
       ...
       **/
      forwardPatchCheckpoints: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, wipeSuffix: bool | boolean | Uint8Array, checkpoints: Vec<AttestorPrimitivesAttestationCheckpoint> | (AttestorPrimitivesAttestationCheckpoint | { blockNumber?: any; digest?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [u64, bool, Vec<AttestorPrimitivesAttestationCheckpoint>]>;
      importCheckpoints: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, checkpoints: Vec<AttestorPrimitivesAttestationCheckpoint> | (AttestorPrimitivesAttestationCheckpoint | { blockNumber?: any; digest?: any } | string | Uint8Array)[]) => SubmittableExtrinsic<ApiType>, [u64, Vec<AttestorPrimitivesAttestationCheckpoint>]>;
      kickActiveAttestor: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestorId: AccountId32 | string | Uint8Array, unregister: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32, bool]>;
      registerAttestor: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestorId: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32]>;
      registerInvulnerable: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestor: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32]>;
      removeAuthorizedAttestor: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestorId: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32]>;
      /**
       ...
       **/
      revertTo: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, checkpointHeight: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u64]>;
      setAttestationChainGenesisBlockNumber: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, genesisBlockNumber: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u64]>;
      setAttestationsPerCheckpoint: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestationsPerCheckpoint: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u32]>;
      setChainAttestationInterval: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, chainAttestationInterval: u64 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u64]>;
      setElectionPolicy: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, newPolicy: PalletAttestationAttestorElectionPolicy | 'OpenToAny' | 'AuthorizedOnly' | 'DeniedToAll' | number | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, PalletAttestationAttestorElectionPolicy]>;
      setMaxAttestors: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, newMax: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u32]>;
      /**
       ...
       **/
      setMaxCatchup: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, maxCatchup: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u32]>;
      setMaxInvulnerables: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, newMax: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u32]>;
      setMinBondRequirement: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, minBondRequirement: u128 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u128]>;
      setTargetSampleSize: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, newTargetSampleSize: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, u32]>;
      unregisterAttestor: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestorId: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32]>;
      unregisterInvulnerable: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, attestor: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, AccountId32]>;
    ...
    attestCoinRewards: {
       ...
       **/
      setAttestCoinToken: AugmentedSubmittable<(token: H160 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [H160]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    supportedChains: {
       ...
       **/
      registerChain: AugmentedSubmittable<(chainId: u64 | AnyNumber | Uint8Array, chainName: Text | string, targetSampleSize: Option<u32> | null | Uint8Array | u32 | AnyNumber, chainAttestationInterval: Option<u64> | null | Uint8Array | u64 | AnyNumber, attestationCheckpointInterval: Option<u32> | null | Uint8Array | u32 | AnyNumber, maxAttestors: Option<u32> | null | Uint8Array | u32 | AnyNumber, maxInvulnerables: Option<u32> | null | Uint8Array | u32 | AnyNumber, attestationChainGenesisBlockNumber: Option<u64> | null | Uint8Array | u64 | AnyNumber, encoding: AttestorPrimitivesChainEncodingVersion | 'V1' | number | Uint8Array, maturityStrategy: Option<Text> | null | Uint8Array | Text | string) => SubmittableExtrinsic<ApiType>, [u64, Text, Option<u32>, Option<u64>, Option<u32>, Option<u32>, Option<u32>, Option<u64>, AttestorPrimitivesChainEncodingVersion, Option<Text>]>;
      /**
       * Removes a supported chain by its chain key. Only accounts in the Operators membership can call this extrinsic.
       **/
      removeChain: AugmentedSubmittable<(chainKey: u64 | AnyNumber | Uint8Array, removeCheckpoints: bool | boolean | Uint8Array) => SubmittableExtrinsic<ApiType>, [u64, bool]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
