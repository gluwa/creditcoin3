...
import { SpConsensusBabeDigestsNextConfigDescriptor, SpConsensusSlotsEquivocationProof, SpSessionMembershipProof, EthereumTransactionTransactionV2, SpConsensusGrandpaEquivocationProof, PalletIdentityJudgement, PalletIdentityBitFlags, PalletIdentityIdentityInfo, PalletImOnlineHeartbeat, PalletImOnlineSr25519AppSr25519Signature, PalletNominationPoolsBondExtra, PalletNominationPoolsClaimPermission, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsConfigOpU128, PalletNominationPoolsConfigOpU32, PalletNominationPoolsConfigOpPerbill, PalletNominationPoolsPoolState, PalletNominationPoolsConfigOpAccountId32, Creditcoin3RuntimeProxyFilter, Creditcoin3RuntimeOpaqueSessionKeys, PalletStakingRewardDestination, PalletStakingPalletConfigOpU128, PalletStakingPalletConfigOpU32, PalletStakingPalletConfigOpPercent, PalletStakingPalletConfigOpPerbill, PalletStakingValidatorPrefs, SpWeightsWeightV2Weight, Creditcoin3RuntimeOriginCaller } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/submittable' {
  interface AugmentedSubmittables<ApiType extends ApiTypes> {
    ...
    nominationPools: {
       ...
       **/
      bondExtraOther: AugmentedSubmittable<(member: AccountId32 | string | Uint8Array, extra: PalletNominationPoolsBondExtra | { FreeBalance: any } | { Rewards: any } | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, PalletNominationPoolsBondExtra]>;
      /**
       * See [`Pallet::chill`].
       **/
       ...
       * See [`Pallet::create`].
       **/
      create: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array, root: AccountId32 | string | Uint8Array, nominator: AccountId32 | string | Uint8Array, bouncer: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId32, AccountId32, AccountId32]>;
      /**
       * See [`Pallet::create_with_pool_id`].
       **/
      createWithPoolId: AugmentedSubmittable<(amount: Compact<u128> | AnyNumber | Uint8Array, root: AccountId32 | string | Uint8Array, nominator: AccountId32 | string | Uint8Array, bouncer: AccountId32 | string | Uint8Array, poolId: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [Compact<u128>, AccountId32, AccountId32, AccountId32, u32]>;
      /**
       * See [`Pallet::join`].
       **/
    ...
    proxy: {
       ...
       **/
      addProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: Creditcoin3RuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Creditcoin3RuntimeProxyFilter, u32]>;
      /**
       * See [`Pallet::announce`].
       **/
       ...
       **/
      killPure: AugmentedSubmittable<(spawner: AccountId32 | string | Uint8Array, proxyType: Creditcoin3RuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number | Uint8Array, index: u16 | AnyNumber | Uint8Array, height: Compact<u32> | AnyNumber | Uint8Array, extIndex: Compact<u32> | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Creditcoin3RuntimeProxyFilter, u16, Compact<u32>, Compact<u32>]>;
      /**
       * See [`Pallet::proxy`].
       **/
      proxy: AugmentedSubmittable<(real: AccountId32 | string | Uint8Array, forceProxyType: Option<Creditcoin3RuntimeProxyFilter> | null | Uint8Array | Creditcoin3RuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Option<Creditcoin3RuntimeProxyFilter>, Call]>;
      /**
       * See [`Pallet::proxy_announced`].
       **/
      proxyAnnounced: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, real: AccountId32 | string | Uint8Array, forceProxyType: Option<Creditcoin3RuntimeProxyFilter> | null | Uint8Array | Creditcoin3RuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number, call: Call | IMethod | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32, Option<Creditcoin3RuntimeProxyFilter>, Call]>;
      /**
       ...
       **/
      removeProxy: AugmentedSubmittable<(delegate: AccountId32 | string | Uint8Array, proxyType: Creditcoin3RuntimeProxyFilter | 'All' | 'NonTransfer' | 'Staking' | number | Uint8Array, delay: u32 | AnyNumber | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, Creditcoin3RuntimeProxyFilter, u32]>;
      /**
       * Generic tx
       **/
      [key: string]: SubmittableExtrinsicFunction<ApiType>;
    ...
    voterList: {
       ...
       **/
      putInFrontOfOther: AugmentedSubmittable<(heavier: AccountId32 | string | Uint8Array, lighter: AccountId32 | string | Uint8Array) => SubmittableExtrinsic<ApiType>, [AccountId32, AccountId32]>;
      /**
       * See [`Pallet::rebag`].
       **/
