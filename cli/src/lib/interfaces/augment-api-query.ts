...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    ...
    balances: {
       ...
       **/
      holds: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Vec<PalletBalancesIdAmount>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
    ...
    fastUnstake: {
       ...
       **/
      queue: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<u128>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
    ...
    session: {
       ...
       **/
      nextKeys: AugmentedQuery<ApiType, (arg: AccountId20 | string | Uint8Array) => Observable<Option<FrontierTemplateRuntimeOpaqueSessionKeys>>, [AccountId20]> & QueryableStorageEntry<ApiType, [AccountId20]>;
      /**
       ...
       **/
      queuedKeys: AugmentedQuery<ApiType, () => Observable<Vec<ITuple<[AccountId20, FrontierTemplateRuntimeOpaqueSessionKeys]>>>, []> & QueryableStorageEntry<ApiType, []>;
      /**
