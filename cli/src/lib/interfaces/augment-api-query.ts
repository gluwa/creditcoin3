...
declare module '@polkadot/api-base/types/storage' {
  interface AugmentedQueries<ApiType extends ApiTypes> {
    attestation: {
       ...
       **/
      accumulatedRewards: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<u128>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
       ...
       **/
      chainReward: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<u128>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
      ...
      checkpoints: AugmentedQuery<ApiType, (arg1: u64 | AnyNumber | Uint8Array, arg2: H256 | string | Uint8Array) => Observable<Option<AttestorPrimitivesAttestationCheckpoint>>, [u64, H256]> & QueryableStorageEntry<ApiType, [u64, H256]>;
      ...
      lastDigest: AugmentedQuery<ApiType, (arg: u64 | AnyNumber | Uint8Array) => Observable<Option<H256>>, [u64]> & QueryableStorageEntry<ApiType, [u64]>;
      /**
       ...
       **/
      ledger: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletAttestationPocLedgerAttestorLedger>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
      ...
      minBondRequirement: AugmentedQuery<ApiType, () => Observable<u128>, []> & QueryableStorageEntry<ApiType, []>;
      /**
       * Where the reward payment should be made. Keyed by stash.
       * 
       * TWOX-NOTE: SAFE since `AccountId` is a secure hash.
       **/
      payee: AugmentedQuery<ApiType, (arg: AccountId32 | string | Uint8Array) => Observable<Option<PalletAttestationPocRewardDestination>>, [AccountId32]> & QueryableStorageEntry<ApiType, [AccountId32]>;
    ...
    prover: {
      queryResultById: AugmentedQuery<ApiType, (arg: H256 | string | Uint8Array) => Observable<Option<PalletProverPrimitivesVerifierExitStatus>>, [H256]> & QueryableStorageEntry<ApiType, [H256]>;
      starkProgramMetadata: AugmentedQuery<ApiType, (arg: u8 | AnyNumber | Uint8Array) => Observable<H256>, [u8]> & QueryableStorageEntry<ApiType, [u8]>;
      /**
       * Generic query
       **/
      [key: string]: QueryableStorageEntry<ApiType>;
