...
declare module '@polkadot/api-base/types/storage' {
    interface AugmentedQueries<ApiType extends ApiTypes> {
        ...
        balances: {
             ...
             **/
            inactiveIssuance: AugmentedQuery<
                ApiType,
                () => Observable<u128>,
                []
            > &
        ...
        fastUnstake: {
             ...
             **/
            counterForQueue: AugmentedQuery<
                ApiType,
                () => Observable<u32>,
                []
            > &
             ...
             * stored in [`Head`].
             **/
            erasToCheckPerBlock: AugmentedQuery<
                ApiType,
                () => Observable<u32>,
                []
            > &
        ...
        identity: {
            ...
            subsOf: AugmentedQuery<
                ...
                (
                    arg: AccountId20 | string | Uint8Array
                ) => Observable<ITuple<[u128, Vec<AccountId20>]>>,
                [AccountId20]
            > &
                QueryableStorageEntry<ApiType, [AccountId20]>;
            /**
            ...
            superOf: AugmentedQuery<
                ...
                (
                    arg: AccountId20 | string | Uint8Array
                ) => Observable<Option<ITuple<[AccountId20, Data]>>>,
                [AccountId20]
            > &
                QueryableStorageEntry<ApiType, [AccountId20]>;
            /**
        ...
        nominationPools: {
             ...
             * Counter for the related counted storage map
             **/
            counterForMetadata: AugmentedQuery<
                ApiType,
                () => Observable<u32>,
                []
            > &
        ...
        session: {
            ...
            nextKeys: AugmentedQuery<
                ...
                (
                    ...
                    Option<FrontierTemplateRuntimeOpaqueSessionKeys>
                >,
                [AccountId20]
            > &
                QueryableStorageEntry<ApiType, [AccountId20]>;
        ...
        staking: {
             ...
             **/
            canceledSlashPayout: AugmentedQuery<
                ApiType,
                () => Observable<u128>,
                []
            > &
             ...
             * Counter for the related counted storage map
             **/
            counterForNominators: AugmentedQuery<
                ApiType,
                () => Observable<u32>,
                []
            > &
             ...
             * Counter for the related counted storage map
             **/
            counterForValidators: AugmentedQuery<
                ApiType,
                () => Observable<u32>,
                []
            > &
             ...
             **/
            minimumActiveStake: AugmentedQuery<
                ApiType,
                () => Observable<u128>,
                []
            > &
             ...
             **/
            minNominatorBond: AugmentedQuery<
                ApiType,
                () => Observable<u128>,
                []
            > &
             ...
             **/
            minValidatorBond: AugmentedQuery<
                ApiType,
                () => Observable<u128>,
                []
            > &
            ...
            spanSlash: AugmentedQuery<
                ...
                [ITuple<[AccountId20, u32]>]
            > &
                QueryableStorageEntry<ApiType, [ITuple<[AccountId20, u32]>]>;
            /**
        ...
        system: {
             ...
             **/
            digest: AugmentedQuery<
                ApiType,
                () => Observable<SpRuntimeDigest>,
                []
            > &
                QueryableStorageEntry<ApiType, []>;
            /**
        ...
        voterList: {
             ...
             * Counter for the related counted storage map
             **/
            counterForListNodes: AugmentedQuery<
                ApiType,
                () => Observable<u32>,
                []
            > &
