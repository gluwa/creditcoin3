...
export default {
    ...
    /**
     * Lookup101: pallet_supported_chains::pallet::Event<T>
     **/
    ...
    /**
     * Lookup102: pallet_prover::pallet::Event<T>
     **/
    PalletProverEvent: {
        _enum: {
    ...
    PalletAttestationPocCall: {
        _enum: {
            ...
            commit_attestation: {
                attestations: 'Vec<AttestorPrimitivesSignedAttestation>',
            },
    ...
    /**
     * Lookup327: pallet_attestation_poc::pallet::RewardDestination<sp_core::crypto::AccountId32>
     **/
    ...
    /**
     * Lookup330: pallet_supported_chains::pallet::Call<T>
     **/
    ...
    /**
     * Lookup331: pallet_prover::pallet::Call<T>
     **/
    PalletProverCall: {
        _enum: {
     ...
     **/
    PalletProverError: {
        _enum: ['StarkProgramMetadataAlreadySet', 'StarkProgramMetadataNotFound'],
    },
    /**
