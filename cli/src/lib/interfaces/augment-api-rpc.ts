...
declare module '@polkadot/rpc-core/types/jsonrpc' {
    interface RpcInterface {
        ...
        childstate: {
            ...
            getStorageEntries: AugmentedRpc<
                (
                    ...
                    keys:
                        | Vec<StorageKey>
                        | (StorageKey | string | Uint8Array | any)[],
                    at?: Hash | string | Uint8Array
        ...
        state: {
             ...
             **/
            subscribeRuntimeVersion: AugmentedRpc<
                () => Observable<RuntimeVersion>
            >;
            /**
        ...
        system: {
             ...
             **/
            addReservedPeer: AugmentedRpc<
                (peer: Text | string) => Observable<Text>
            >;
            /**
             * Retrieves the chain
             **/
