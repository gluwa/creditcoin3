...
declare module '@polkadot/api-base/types/events' {
    interface AugmentedEvents<ApiType extends ApiTypes> {
        ...
        baseFee: {
            ...
            NewBaseFeePerGas: AugmentedEvent<
                ApiType,
                [fee: U256],
                { fee: U256 }
            >;
        ...
        imOnline: {
            ...
            SomeOffline: AugmentedEvent<
                ApiType,
                [offline: Vec<ITuple<[AccountId20, PalletStakingExposure]>>],
                { offline: Vec<ITuple<[AccountId20, PalletStakingExposure]>> }
            >;
            /**
             * Generic event
        ...
        nominationPools: {
            ...
            Bonded: AugmentedEvent<
                ApiType,
                [member: AccountId20, poolId: u32, bonded: u128, joined: bool],
                { member: AccountId20; poolId: u32; bonded: u128; joined: bool }
            >;
            /**
            ...
            Created: AugmentedEvent<
                ApiType,
                [depositor: AccountId20, poolId: u32],
                { depositor: AccountId20; poolId: u32 }
            >;
            /**
            ...
            PaidOut: AugmentedEvent<
                ApiType,
                [member: AccountId20, poolId: u32, payout: u128],
                { member: AccountId20; poolId: u32; payout: u128 }
            >;
            /**
            ...
            PoolCommissionUpdated: AugmentedEvent<
                ApiType,
                [poolId: u32, current: Option<ITuple<[Perbill, AccountId20]>>],
                { poolId: u32; current: Option<ITuple<[Perbill, AccountId20]>> }
            >;
            /**
            ...
            Withdrawn: AugmentedEvent<
                ApiType,
                [member: AccountId20, poolId: u32, balance: u128, points: u128],
                {
                    member: AccountId20;
                    poolId: u32;
                    balance: u128;
        ...
        staking: {
            ...
            Kicked: AugmentedEvent<
                ApiType,
                [nominator: AccountId20, stash: AccountId20],
                { nominator: AccountId20; stash: AccountId20 }
            >;
            /**
            ...
            PayoutStarted: AugmentedEvent<
                ApiType,
                [eraIndex: u32, validatorStash: AccountId20],
                { eraIndex: u32; validatorStash: AccountId20 }
            >;
            /**
            ...
            Slashed: AugmentedEvent<
                ApiType,
                [staker: AccountId20, amount: u128],
                { staker: AccountId20; amount: u128 }
            >;
            /**
            ...
            SlashReported: AugmentedEvent<
                ApiType,
                [validator: AccountId20, fraction: Perbill, slashEra: u32],
                { validator: AccountId20; fraction: Perbill; slashEra: u32 }
            >;
            /**
            ...
            ValidatorPrefsSet: AugmentedEvent<
                ApiType,
                [stash: AccountId20, prefs: PalletStakingValidatorPrefs],
                { stash: AccountId20; prefs: PalletStakingValidatorPrefs }
            >;
            /**
        ...
        voterList: {
            ...
            Rebagged: AugmentedEvent<
                ApiType,
                [who: AccountId20, from: u64, to: u64],
                { who: AccountId20; from: u64; to: u64 }
            >;
            /**
