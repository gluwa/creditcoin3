...
import type { AttestorPrimitivesAttestationCheckpoint, AttestorPrimitivesSignedAttestation, Creditcoin3RuntimeProxyFilter, EthereumLog, EvmCoreErrorExitReason, FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, PalletImOnlineSr25519AppSr25519Public, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsCommissionClaimPermission, PalletNominationPoolsPoolState, PalletProverPrimitivesVerifierExitStatus, PalletStakingForcing, PalletStakingRewardDestination, PalletStakingValidatorPrefs, SpConsensusGrandpaAppPublic, SpRuntimeDispatchError, SpStakingExposure } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    attestation: {
      ...
      RewardClaimed: AugmentedEvent<ApiType, [stash: AccountId32, amount: u128], { stash: AccountId32, amount: u128 }>;
      RewardPaid: AugmentedEvent<ApiType, [chainKey: u64, stash: AccountId32, amount: u128], { chainKey: u64, stash: AccountId32, amount: u128 }>;
    ...
    supportedChains: {
       ...
       **/
      ChainRegistered: AugmentedEvent<ApiType, [chainKey: u64, chainId: u64, chainName: Bytes], { chainKey: u64, chainId: u64, chainName: Bytes }>;
      /**
       * A chain has been removed with a given ID
       **/
      ChainRemoved: AugmentedEvent<ApiType, [chainKey: u64, chainId: u64, chainName: Bytes], { chainKey: u64, chainId: u64, chainName: Bytes }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
