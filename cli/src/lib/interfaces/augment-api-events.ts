...
import type { Bytes, Null, Option, Result, Text, U256, U8aFixed, Vec, bool, u128, u16, u32, u64, u8 } from '@polkadot/types-codec';
import type { ITuple } from '@polkadot/types-codec/types';
import type { AccountId32, H160, H256, Perbill, Permill } from '@polkadot/types/interfaces/runtime';
import type { AttestorPrimitivesAttestationCheckpoint, AttestorPrimitivesChainEncodingVersion, Creditcoin3RuntimeProxyFilter, EthereumLog, EvmCoreErrorExitReason, FrameSupportDispatchDispatchInfo, FrameSupportTokensMiscBalanceStatus, PalletAttestationAttestorElectionPolicy, PalletImOnlineSr25519AppSr25519Public, PalletNominationPoolsCommissionChangeRate, PalletNominationPoolsCommissionClaimPermission, PalletNominationPoolsPoolState, PalletStakingForcing, PalletStakingRewardDestination, PalletStakingValidatorPrefs, SpConsensusGrandpaAppPublic, SpRuntimeDispatchError, SpStakingExposure } from '@polkadot/types/lookup';
...
declare module '@polkadot/api-base/types/events' {
  interface AugmentedEvents<ApiType extends ApiTypes> {
    ...
    attestation: {
      ...
      AttestorsElected: AugmentedEvent<ApiType, [epoch: u64, chainKey: u64, attestors: Vec<AccountId32>], { epoch: u64, chainKey: u64, attestors: Vec<AccountId32> }>;
       ...
       **/
      ForwardCheckpointPatchApplied: AugmentedEvent<ApiType, [chainKey: u64, wipedSuffix: bool, tipBlockNumber: u64], { chainKey: u64, wipedSuffix: bool, tipBlockNumber: u64 }>;
      /**
       ...
       **/
      RevertedAttestationChainTo: AugmentedEvent<ApiType, [chainKey: u64, checkpointHeight: u64, checkpointDigest: H256], { chainKey: u64, checkpointHeight: u64, checkpointDigest: H256 }>;
    ...
    attestCoinRewards: {
       ...
       **/
      AttestCoinTokenSet: AugmentedEvent<ApiType, [token: H160], { token: H160 }>;
      /**
       * Reward points credited to stashes after a committed attestation (one unit per eligible signer).
       **/
      CommitSignersRewarded: AugmentedEvent<ApiType, [chainKey: u64, signers: u32, perSigner: u128], { chainKey: u64, signers: u32, perSigner: u128 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    proxy: {
       ...
       * A proxy was added.
       **/
      ProxyAdded: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: Creditcoin3RuntimeProxyFilter, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: Creditcoin3RuntimeProxyFilter, delay: u32 }>;
      /**
       ...
       * A proxy was removed.
       **/
      ProxyRemoved: AugmentedEvent<ApiType, [delegator: AccountId32, delegatee: AccountId32, proxyType: Creditcoin3RuntimeProxyFilter, delay: u32], { delegator: AccountId32, delegatee: AccountId32, proxyType: Creditcoin3RuntimeProxyFilter, delay: u32 }>;
      /**
       * A pure account has been created by new proxy with given
       * disambiguation index and proxy type.
       **/
      PureCreated: AugmentedEvent<ApiType, [pure: AccountId32, who: AccountId32, proxyType: Creditcoin3RuntimeProxyFilter, disambiguationIndex: u16], { pure: AccountId32, who: AccountId32, proxyType: Creditcoin3RuntimeProxyFilter, disambiguationIndex: u16 }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    randomness: {
      StoreRandomnessForEpoch: AugmentedEvent<ApiType, [epochIndex: u64, randomness: U8aFixed], { epochIndex: u64, randomness: U8aFixed }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
    ...
    supportedChains: {
       ...
       **/
      ChainRegistered: AugmentedEvent<ApiType, [chainKey: u64, chainId: u64, chainName: Bytes, chainEncoding: AttestorPrimitivesChainEncodingVersion, maturityStrategy: Text], { chainKey: u64, chainId: u64, chainName: Bytes, chainEncoding: AttestorPrimitivesChainEncodingVersion, maturityStrategy: Text }>;
      /**
       * A chain has been removed with a given ID
       **/
      ChainRemoved: AugmentedEvent<ApiType, [chainKey: u64, chainId: u64, chainName: Bytes, chainEncoding: AttestorPrimitivesChainEncodingVersion, maturityStrategy: Text], { chainKey: u64, chainId: u64, chainName: Bytes, chainEncoding: AttestorPrimitivesChainEncodingVersion, maturityStrategy: Text }>;
      /**
       * Generic event
       **/
      [key: string]: AugmentedEvent<ApiType>;
