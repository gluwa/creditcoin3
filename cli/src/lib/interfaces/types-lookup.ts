...
declare module '@polkadot/types/lookup' {
    ...
    /** @name PalletAttestationPocEvent (91) */
    interface PalletAttestationPocEvent extends Enum {
        readonly isAttestorRegistered: boolean;
        readonly asAttestorRegistered: AccountId32;
        readonly isAttestorUnregistered: boolean;
        readonly asAttestorUnregistered: AccountId32;
        readonly isInvulnerableRegistered: boolean;
        readonly asInvulnerableRegistered: AccountId32;
        readonly isInvulnerableUnregistered: boolean;
        readonly asInvulnerableUnregistered: AccountId32;
        readonly isChainBootstrapped: boolean;
        readonly asChainBootstrapped: ITuple<[u64, AttestorPrimitivesSignedAttestation]>;
        ...
        readonly asCheckpointReached: ITuple<[u64, AttestorPrimitivesSignedAttestation]>;
        readonly isComitteeSetSizeChanged: boolean;
        readonly asComitteeSetSizeChanged: u32;
        readonly type:
            | 'AttestorRegistered'
    ...
    interface AttestorPrimitivesAttestation extends Struct {
        ...
        readonly txRoot: U8aFixed;
        readonly rxRoot: U8aFixed;
    ...
    interface PalletProverEvent extends Enum {
        readonly isProverRegistered: boolean;
        readonly asProverRegistered: AccountId32;
        readonly isProverChainPriceConfigurationSet: boolean;
        readonly asProverChainPriceConfigurationSet: ITuple<
            [AccountId32, Vec<ProverPrimitivesChainPriceConfiguration>]
        >;
        readonly isProverClaimSubmitted: boolean;
        readonly asProverClaimSubmitted: ITuple<[AccountId32, AccountId32, H256, PalletProverClaim]>;
        readonly isClaimVerified: boolean;
        readonly asClaimVerified: ITuple<[H256, AccountId32]>;
        readonly type:
            | 'ProverRegistered'
            | 'ProverChainPriceConfigurationSet'
            | 'ProverClaimSubmitted'
            | 'ClaimVerified';
    }

    /** @name ProverPrimitivesChainPriceConfiguration (100) */
    interface ProverPrimitivesChainPriceConfiguration extends Struct {
        readonly chainId: u64;
        readonly price: u64;
    }

    /** @name PalletProverClaim (101) */
    interface PalletProverClaim extends Struct {
        readonly chainId: u64;
        readonly id: PalletProverClaimId;
        readonly feltRanges: Vec<PalletProverFeltRange>;
    }

    /** @name PalletProverClaimId (102) */
    interface PalletProverClaimId extends Struct {
        readonly kind: PalletProverClaimKind;
        readonly blockItemId: PalletProverBlockItemIdentifier;
    }

    /** @name PalletProverClaimKind (103) */
    interface PalletProverClaimKind extends Enum {
        readonly isTx: boolean;
        readonly isRx: boolean;
        readonly type: 'Tx' | 'Rx';
    }

    /** @name PalletProverBlockItemIdentifier (104) */
    interface PalletProverBlockItemIdentifier extends Struct {
        readonly blockNumber: u64;
        readonly index: u32;
    }

    /** @name PalletProverFeltRange (106) */
    interface PalletProverFeltRange extends Struct {
        readonly start: u32;
        readonly end: u32;
    }
    ...
    /** @name FrameSupportDispatchPerDispatchClassWeightsPerClass (117) */
    ...
    /** @name FrameSystemLimitsBlockLength (120) */
    interface FrameSystemLimitsBlockLength extends Struct {
        readonly max: FrameSupportDispatchPerDispatchClassU32;
    }

    /** @name FrameSupportDispatchPerDispatchClassU32 (121) */
    ...
    /** @name SpWeightsRuntimeDbWeight (122) */
    interface SpWeightsRuntimeDbWeight extends Struct {
        readonly read: u64;
        readonly write: u64;
    }

    /** @name SpVersionRuntimeVersion (123) */
    ...
    /** @name SpCoreSr25519VrfVrfSignature (142) */
    interface SpCoreSr25519VrfVrfSignature extends Struct {
        readonly output: U8aFixed;
        readonly proof: U8aFixed;
    }

    /** @name SpConsensusBabeDigestsSecondaryPlainPreDigest (144) */
    interface SpConsensusBabeDigestsSecondaryPlainPreDigest extends Struct {
        readonly authorityIndex: u32;
        readonly slot: u64;
    }

    /** @name SpConsensusBabeDigestsSecondaryVRFPreDigest (145) */
    ...
    /** @name SpConsensusBabeBabeEpochConfiguration (147) */
    ...
    /** @name PalletBalancesIdAmount (165) */
    ...
    /** @name PalletStakingStakingLedger (170) */
    ...
    /** @name PalletStakingUnlockChunk (172) */
    interface PalletStakingUnlockChunk extends Struct {
        readonly value: Compact<u128>;
        readonly era: Compact<u32>;
    }

    /** @name PalletStakingRewardDestination (175) */
    ...
    /** @name PalletStakingNominations (176) */
    ...
    /** @name PalletStakingActiveEraInfo (178) */
    interface PalletStakingActiveEraInfo extends Struct {
        readonly index: u32;
        readonly start: Option<u64>;
    }

    /** @name PalletStakingEraRewardPoints (181) */
    interface PalletStakingEraRewardPoints extends Struct {
        readonly total: u32;
        readonly individual: BTreeMap<AccountId32, u32>;
    }

    /** @name PalletStakingUnappliedSlash (186) */
    ...
    /** @name PalletStakingSlashingSlashingSpans (190) */
    ...
    /** @name PalletStakingSlashingSpanRecord (191) */
    ...
    /** @name PalletStakingPalletError (201) */
    ...
    /** @name SpStakingOffenceOffenceDetails (202) */
    interface SpStakingOffenceOffenceDetails extends Struct {
        readonly offender: ITuple<[AccountId32, PalletStakingExposure]>;
        readonly reporters: Vec<AccountId32>;
    }

    /** @name Creditcoin3RuntimeOpaqueSessionKeys (206) */
    ...
    /** @name SpCoreCryptoKeyTypeId (208) */
    ...
    /** @name PalletGrandpaStoredState (211) */
    ...
    /** @name PalletGrandpaStoredPendingChange (212) */
    ...
    /** @name SpConsensusGrandpaEquivocationProof (216) */
    interface SpConsensusGrandpaEquivocationProof extends Struct {
        readonly setId: u64;
        readonly equivocation: SpConsensusGrandpaEquivocation;
    }

    /** @name SpConsensusGrandpaEquivocation (217) */
    ...
    /** @name SpConsensusGrandpaAppSignature (220) */
    ...
    /** @name PalletBagsListListNode (234) */
    ...
    /** @name PalletBagsListListBag (235) */
    interface PalletBagsListListBag extends Struct {
        readonly head: Option<AccountId32>;
        readonly tail: Option<AccountId32>;
    }

    /** @name PalletBagsListCall (236) */
    ...
    /** @name PalletBagsListListListError (239) */
    ...
    /** @name Creditcoin3RuntimeOriginCaller (247) */
    ...
    /** @name FrameSupportDispatchRawOrigin (248) */
    ...
    /** @name PalletEthereumRawOrigin (249) */
    ...
    /** @name PalletFastUnstakeCall (293) */
    ...
    /** @name PalletNominationPoolsCall (294) */
    ...
    /** @name PalletNominationPoolsBondExtra (295) */
    ...
    /** @name PalletNominationPoolsConfigOpU128 (296) */
    ...
    /** @name PalletNominationPoolsConfigOpU32 (297) */
    ...
    /** @name PalletNominationPoolsConfigOpPerbill (298) */
    ...
    /** @name PalletNominationPoolsConfigOpAccountId32 (299) */
    ...
    /** @name PalletNominationPoolsClaimPermission (300) */
    ...
    /** @name PalletAttestationPocCall (319) */
    interface PalletAttestationPocCall extends Enum {
        ...
        readonly isSetComitteeSetSize: boolean;
        readonly asSetComitteeSetSize: {
            readonly newComitteeSetSize: u32;
        } & Struct;
    ...
    /** @name PalletSupportedChainsCall (321) */
    ...
    /** @name PalletProverCall (322) */
    interface PalletProverCall extends Enum {
        readonly isRegisterProver: boolean;
        readonly asRegisterProver: {
            readonly prover: PalletProverProver;
        } & Struct;
        readonly isSetChainPriceConfig: boolean;
        readonly asSetChainPriceConfig: {
            readonly chainPriceConfigs: Vec<ProverPrimitivesChainPriceConfiguration>;
        } & Struct;
        readonly isSubmitClaim: boolean;
        readonly asSubmitClaim: {
            readonly claim: PalletProverClaim;
        } & Struct;
        ...
        readonly type: 'RegisterProver' | 'SetChainPriceConfig' | 'SubmitClaim' | 'SubmitProof';
    }

    /** @name PalletProverProver (323) */
    interface PalletProverProver extends Struct {
        readonly nickname: Bytes;
    }
    ...
    /** @name PalletProxyProxyDefinition (328) */
    ...
    /** @name PalletProxyAnnouncement (332) */
    ...
    /** @name PalletFastUnstakeUnstakeRequest (346) */
    ...
    /** @name PalletFastUnstakeError (349) */
    ...
    /** @name PalletNominationPoolsPoolMember (350) */
    ...
    /** @name PalletNominationPoolsBondedPoolInner (355) */
    ...
    /** @name PalletNominationPoolsCommission (356) */
    ...
    /** @name PalletNominationPoolsPoolRoles (359) */
    ...
    /** @name PalletNominationPoolsRewardPool (360) */
    ...
    /** @name PalletNominationPoolsSubPools (361) */
    ...
    /** @name PalletNominationPoolsUnbondPool (362) */
    ...
    /** @name PalletNominationPoolsError (369) */
    ...
    /** @name PalletNominationPoolsDefensiveError (370) */
    ...
    /** @name FpRpcTransactionStatus (373) */
    ...
    /** @name PalletEvmCodeMetadata (388) */
    interface PalletEvmCodeMetadata extends Struct {
        readonly size_: u64;
        readonly hash_: H256;
    }

    /** @name PalletEvmError (390) */
    ...
    /** @name PalletHotfixSufficientsError (391) */
    ...
    /** @name PalletAttestationPocError (394) */
    interface PalletAttestationPocError extends Enum {
        ...
        readonly isMaxAttestorsCannotBeChanged: boolean;
        ...
        readonly isAddressIsInvulnerable: boolean;
        readonly isAddressIsNotInvulnerable: boolean;
        readonly isChainAlreadyBootstrapped: boolean;
        readonly isChainIsNotBootstrapped: boolean;
        readonly isNotEligible: boolean;
    ...
    /** @name PalletSupportedChainsError (395) */
    ...
    /** @name PalletProverError (399) */
    interface PalletProverError extends Enum {
        readonly isProverAlreadyRegistered: boolean;
        readonly isProverNotExists: boolean;
        readonly isProverAlreadyExists: boolean;
        readonly isChainPriceConfigurationNotFound: boolean;
        readonly isClaimNotExists: boolean;
        readonly isWrongClaimHash: boolean;
        readonly isInvalidProofSubmitted: boolean;
        readonly isBalanceToLow: boolean;
        readonly isChainNotSupported: boolean;
        readonly type:
    ...
    /** @name SpRuntimeMultiSignature (401) */
    ...
    /** @name Creditcoin3RuntimeRuntime (415) */
