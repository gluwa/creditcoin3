...
declare module '@polkadot/types/lookup' {
  ...
  /** @name Creditcoin3RuntimeOpaqueSessionKeys (189) */
  ...
  /** @name Creditcoin3RuntimeOriginCaller (230) */
  ...
  /** @name Creditcoin3RuntimeRuntime (385) */
