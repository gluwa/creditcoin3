/**
 * Shared message types used by both attestor and relayer.
 */

/** A message voted on by the attestor and forwarded to the relayer for delivery. */
export interface DeliveredMessage {
  ...
  requiresAck: boolean;
  /** ECDSA signatures from attestor(s) voting on this message */
  signedVotes: string[];
}
