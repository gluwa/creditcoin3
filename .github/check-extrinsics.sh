...
for RUNTIME in "${runtimes[@]}"; do
  ...
  # polkadot-js-metadata-cmp wss://rpc.usc-mainnet.creditcoin.network/ws "$HEAD_WS" > metadata-cmp-with-mainnet.txt
  polkadot-js-metadata-cmp wss://rpc.usc-testnet2.creditcoin.network/ws "$HEAD_WS" > metadata-cmp-with-testnet.txt
