...
WHITELIST="$WHITELIST reward_commit_signers take_accrued_for_claim accrued_of erc20_token reward_vault restore_accrued claim_signing_message claim_nonce_of commit_claim undo_claim_commit"
