...
WHITELIST="MaxAttestorsDefault<T MaxInvulernablesDefault<T get_locked_balance is_chain_supported supported_chains attestor_bls_pubkey is_attestor last_digest contains_digest get("
