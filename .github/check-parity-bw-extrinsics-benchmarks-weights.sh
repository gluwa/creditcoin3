...
WHITELIST="MaxAttestorsDefault<T MaxInvulernablesDefault<T AttestationIntervalDefault<T DefaultAttestationsPerCheckpoint<T DefaultMinBondRequirement<T  TargetSampleSizeDefault<T"
