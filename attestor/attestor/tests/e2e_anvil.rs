...
sol! {
    #[sol(rpc, bytecode = "")]
    contract TestOutbox {
        ...
        event MessagePublished(bytes32 indexed messageId, address indexed emitterAddress, bytes payload);
    }
}
...
async fn outbox_publish_indexed_signed_and_reaches_quorum() {
    ...
    // 3. Resolve it through the real resolver (config override path) — asserts Outbox.chainKey().
